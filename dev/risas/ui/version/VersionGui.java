...
import dev.risas.util.render.UIUtil;
...
public final class VersionGui extends GuiScreen {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        //Draw dev.risas.ui.clickgui.impl.astolfo.buttons
    ...
    public boolean getEnabled() {
       ...
       if (ip != null && Objects.requireNonNull(Rise.INSTANCE.getModuleManager().getModule("Disabler")).isEnabled() && ((BooleanSetting) Objects.requireNonNull(Rise.INSTANCE.getModuleManager().getSetting("Disabler", "Hypixel"))).isEnabled() && (ip.contains("hypixel.net") && !ip.contains("ruhypixel.net") || ip.contains("2606:4700::6810:4e15")))
            return true;
        return enabled;
    }
