...
import dev.risas.ui.proxy.ProxyGUI;
...
//        mc.timer.timerSpeed = 3f;
        ...
        changes.add("Rise 5.101 Lol");
        changes.add("Fixed Via?");
        ...
        if (Rise.devMode)
            CustomFont.drawString("Developer Mode (" + "Benhakx" + ")", sr.getScaledWidth() - 95, 7, Color.WHITE.getRGB());
