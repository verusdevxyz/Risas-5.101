...
public final class ProxyGUI extends GuiScreen {
    ...
    public void drawScreen(final int x2, final int y2, final float z2) {
        MainMenu.drawBackground(x2, y2, width, height);
        ...
        if (sr.getScaledHeight() > 300) {
            CustomFont.drawString(Rise.CLIENT_CREDITS, sr.getScaledWidth() - CustomFont.getWidth(Rise.CLIENT_CREDITS) - 2, sr.getScaledHeight() - 12.5, new Color(255, 255, 255, 180).hashCode());
            CustomFont.drawString(Rise.CLIENT_NAME + " " + Rise.CLIENT_VERSION, 2, sr.getScaledHeight() - 12.5, new Color(255, 255, 255, 180).hashCode());
        }
