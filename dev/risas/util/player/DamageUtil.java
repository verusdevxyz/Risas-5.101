            ...
            for (int i = 0; i < packetCount; i++) {
                switch (type) {
                    case POSITION_ROTATION: {
                        PacketUtil.sendPacket(new C03PacketPlayer.C06PacketPlayerPosLook(x, y + value, z, mc.thePlayer.rotationYaw, mc.thePlayer.rotationPitch, false));
                        PacketUtil.sendPacket(new C03PacketPlayer.C06PacketPlayerPosLook(x, y, z, mc.thePlayer.rotationYaw, mc.thePlayer.rotationPitch, false));
                        break;
                    }

                    case POSITION: {
                        PacketUtil.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(x, y + value, z, false));
