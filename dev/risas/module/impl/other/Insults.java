...
public final class Insults extends Module {
    ...
    private final String[] insults = {
            ...
            "Get Rise from riseclient.com",
            "Did :user:'s dad not come back after he wanted to buy some milk?",
            "RISE against other cheaters by getting Rise from riseclient.com",
            "Are you afraid of me",
            "Why not use Rise?",
            "#SwitchToRise5",
            ":user: I saw you in femboy meetup, hi!",
            "Buy Rise, don't be like :user:",
            ...
            "Pay to lose",
            "Get good, get Rise @ riseclient.com",
    ...
    private final String[] sigma = {
            "Learn your alphabet with the Rise client: Alan32, Auth, Hazsi, Herkowskyyy, Nicklas, RISE, Strikeless, and Tecnio!",
            ...
            "Get Rise hack client at riseclient.com to get the best mineman skills!",
