...
import dev.risas.module.impl.render.particles.Particle;
...
import dev.risas.util.misc.EvictingList;
import dev.risas.util.misc.TPAura;
...
public final class Test extends Module implements InstanceAccess {
    ...
    private ArrayList<dev.risas.util.pathfinding.Vec3> path = new ArrayList<>();
