...
public final class Step extends Module {
    ...
    public void onUpdateAlwaysInGui() {
        height.hidden = !(mode.is("Vanilla") || mode.is("NCP"));
    ...
    public static void onStep() {
        ...
        switch (modeString) {
            ...
            case "Hypixel":
                if (height > 2.019) {
                    values = new double[]{0.425f, 0.821, 0.699, 0.599, 1.022, 1.372, 1.652, 1.869, 2.019, 1.919};
                } else if (height > 1.869) {
                    values = new double[]{0.425f, 0.821, 0.699, 0.599, 1.022, 1.372, 1.652, 1.869};
                } else if (height > 1.5) {
                    values = new double[]{0.425f, 0.821, 0.699, 0.599, 1.022, 1.372, 1.652};
                } else if (height > 1.015) {
                    values = new double[]{0.42f, 0.7532, 1.01, 1.093, 1.015};
                } else if (height > 0.875) {
                    values = new double[]{0.42f, 0.7532};
                } else if (height > 0.6) {
                    values = new double[]{0.39f, 0.6938};
                }
