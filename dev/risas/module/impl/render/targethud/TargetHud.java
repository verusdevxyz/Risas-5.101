 ...
 */
package dev.risas.module.impl.render.targethud;
...
import dev.risas.util.render.StencilUtil;
...
public final class TargetHud extends Module {
    ...
    private final ModeSetting mode = new ModeSetting("Mode", this, "Normal", "Normal", "Simple", "Classic", "Tecnio", "Herkowskyyy", "Other", "FpsEater3000", "Exhibition", "OldExhibition", "Remix");
    ...
    public void onRender2DEvent(final Render2DEvent event) {
        ...
        switch (mode.getMode()) {
            ...
            case "FpsEater3000": {
                ...
                //Background
                if (backGround.isEnabled())
                    RenderUtil.roundedRect(posX + 38 + 2, posY - 34, 129, 40, 8, new Color(0, 0, 0, 110));
            ...
            case "Remix": {
                ...
                if (target != null && networkPlayerInfo != null)
                    GuiPlayerTabOverlay.drawPing(103, 50, 14, networkPlayerInfo);
                // Round.
                double cockWidth = 0.0;
                cockWidth = MathUtil.round(cockWidth, (int) 5.0);
                if (cockWidth < 50.0) {
