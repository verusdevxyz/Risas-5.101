...
public final class TabGui extends Module {
    ...
    public void onRender2DEvent(final Render2DEvent event) {
        ...
        // x and y position offset depending on theme.
        float xOffset = 0;
        float yOffset = 0;
        ...
        switch (theme) {
            ...
            case "rise":
                ...
                break;
            case "classic revamp":
                yOffset = IngameGUI.positionOfLastModule + 7;
                break;
        }

        // The base positions for the TabGUI.
        final float x = 2 + xOffset;
        ...
        for (final Category category : Category.values()) {
            if ( category != Category.SCRIPTS && category != Category.CONFIGS && category != Category.INFO/* && category != Category.STORE*/) {
