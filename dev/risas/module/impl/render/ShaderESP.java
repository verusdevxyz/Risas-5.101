...
import dev.risas.util.render.ShaderUtil;
...
public class ShaderESP extends Module {
    ...
    private ShaderUtil shaderProgram;

    public static boolean runningShader;

    public ShaderESP() {
    	try {
    		shaderProgram = new ShaderUtil("rise/shader/fade_outline.glsl");
    ...
    public void onRender2DEvent(final Render2DEvent event) {
        if (mc.gameSettings.showDebugInfo || shaderProgram == null)
            return;
