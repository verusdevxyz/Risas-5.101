...
import dev.risas.module.impl.render.XRay;
...
public class Block {
    ...
    public void addCollisionBoxesToList(final World worldIn, final BlockPos pos, final IBlockState state, final AxisAlignedBB mask, final List<AxisAlignedBB> list, final Entity collidingEntity) {
        final BlockCollideEvent blockCollideEvent = new BlockCollideEvent(this.getCollisionBoundingBox(worldIn, pos, state), state.getBlock(), pos, pos.getX(), pos.getY(), pos.getZ());
