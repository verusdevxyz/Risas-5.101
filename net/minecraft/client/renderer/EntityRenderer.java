...
import dev.risas.event.impl.render.Shader3DEvent;
import dev.risas.module.impl.combat.BackTrack;
import dev.risas.module.impl.combat.WTap;
import dev.risas.module.impl.ghost.AimAssist;
import dev.risas.module.impl.ghost.Reach;
import dev.risas.module.impl.player.Infinite;
...
public class EntityRenderer implements IResourceManagerReloadListener, InstanceAccess {
    ...
    public void getMouseOver(final float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            double reach = this.getModule(Reach.class).isEnabled()
            ...
            final MouseOverEvent mouseOverEvent = new MouseOverEvent(reach, expand);
            mouseOverEvent.call();
