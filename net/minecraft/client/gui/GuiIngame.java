...
import dev.risas.event.impl.render.PreBlurEvent;
import dev.risas.font.CustomFont;
import dev.risas.font.fontrenderer.TTFFontRenderer;
import dev.risas.module.impl.render.Blur;
...
public class GuiIngame extends Gui implements InstanceAccess {
    ...
    public void renderGameOverlay(final float partialTicks) {
        ...
        if (scoreobjective1 != null) {
            if (!(dev.risas.module.impl.render.Scoreboard.instance.hideScoreboardSetting.isEnabled() && dev.risas.module.impl.render.Scoreboard.instance.isEnabled())) {
    ...
    private void renderScoreboard(final ScoreObjective p_180475_1_, final ScaledResolution p_180475_2_) {
        ...
        final boolean customFont = dev.risas.module.impl.render.Scoreboard.instance.customFont.isEnabled() && dev.risas.module.impl.render.Scoreboard.instance.isEnabled();
        final boolean customScoreboard = dev.risas.module.impl.render.Scoreboard.instance.customScoreboard.isEnabled() && dev.risas.module.impl.render.Scoreboard.instance.isEnabled();
        final boolean hideBackground = dev.risas.module.impl.render.Scoreboard.instance.hideBackgroundSetting.isEnabled() && dev.risas.module.impl.render.Scoreboard.instance.isEnabled();
